...
def main():
    ...
    p(net, "udpate of the booking proposal is requested")
    a(net, "request update of the booking proposal", "udpate of the booking proposal is requested")
    a(net, "udpate of the booking proposal is requested", "prepare booking proposal XOR JOIN")
    t(net, "booking proposal is accepted")
    ...
    a(net, "price inquiry is transformed into travel request", "decide on approval requirements XOR JOIN")
    t(net, "decide on approval requirements")
    a(net, "decide on approval requirements XOR JOIN", "decide on approval requirements")
    ...
    a(net, "decide on request FALSE", "decide on request CORRECTION")
    ...
    p(net, "udpate of the booking proposal is requested")
    a(net, "request update of the booking proposal", "udpate of the booking proposal is requested")
    t(net, "prepare booking proposal FROM udpate of the booking proposal is requested")
    a(net, "udpate of the booking proposal is requested", "prepare booking proposal FROM udpate of the booking proposal is requested")
    a(net, "prepare booking proposal FROM udpate of the booking proposal is requested", "prepare booking proposal XOR JOIN")
    ...
    p(net, "Reporting FROM booking is not needed")
    ...
    a(net, "expnse report approved AND", "expense report approved AND CALC")
